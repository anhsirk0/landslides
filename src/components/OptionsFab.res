...
let make = () => {
  <div
    className="fixed bottom-[1vh] right-[1vh] max-w-[3rem] max-h-[3rem] rounded-box hover:max-h-[98vh] hover:max-w-[16rem] overflow-hidden group flex flex-col transitional z-50">
    <div
      ...
      <div
        className="grow h-full [&>*]:hidden group-hover:[&>*]:flex group-hover:[&>*]:animate-appear min-h-0">
        <ThemeList />
      </div>
